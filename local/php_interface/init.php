...
if (!defined("SZCUBE_HOME_BANNER_AUTO_NAME_PREFIX")) {
    define("SZCUBE_HOME_BANNER_AUTO_NAME_PREFIX", "__AUTO_HOME_BANNER__:");
}
...
if (!function_exists("szcubeIsAutoHomeBannerName")) {
    function szcubeIsAutoHomeBannerName($value)
    {
        ...
        return strpos($value, SZCUBE_HOME_BANNER_AUTO_NAME_PREFIX) === 0;
    }
}

if (!function_exists("szcubeGetHomeBannerPublicTitle")) {
    function szcubeGetHomeBannerPublicTitle($value)
    {
        $value = trim((string)$value);
        if ($value === "" || szcubeIsAutoHomeBannerName($value)) {
            return "";
        }
