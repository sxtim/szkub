  ...
  <div class="filters">
    <div class="filters__controls">
      <div class="filter filter--select">
        ...
        <?php $renderProjectDropdown("short-project"); ?>
      </div>
    ...
    <div class="filters__actions">
      ...
      <button class="btn btn--primary" type="button" data-apartment-filter-submit>Выбрать квартиру</button>
      <div class="filters__summary" data-apartment-filter-summary>Найдено <?= (int)$count ?> <?= htmlspecialcharsbx($pluralize($count)) ?></div>
    </div>
  </div>
    ...
    <div class="filters-popup__dialog" role="dialog" aria-modal="true" aria-labelledby="filters-title">
      ...
      <div class="filters-popup__grid">
        <div class="filters-popup__col">
          <div class="filter filter--select">
            <span class="filter__label">ЖК</span>
            <?php $renderProjectDropdown("popup-project"); ?>
          </div>
        ...
        <div class="filters-popup__col">
          ...
          <?php $renderCheckboxGroup("Статус", "status", $statuses, "popup-status"); ?>
          <?php $renderCheckboxGroup("Отделка", "finish", $finishes, "popup-finish"); ?>
        </div>
