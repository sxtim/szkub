...
<div class="news-detail" id="<?= $this->GetEditAreaId($arResult["ID"]); ?>">
	...
	<div class="article-hero__cta">
		<button class="btn btn--primary promotions-detail__cta-btn" type="button" data-contact-open="contact" data-contact-title="Получить консультацию">Получить консультацию</button>
	</div>
</div>
<?
