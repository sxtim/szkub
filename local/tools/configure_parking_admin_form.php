...
if (PHP_SAPI === "cli") {
    ...
    if (isset($options["help"])) {
        echo "Usage: php local/tools/configure_parking_admin_form.php [--code=parking] [--admin-user-id=1] [--dry-run=1]\n";
        exit(0);
    }
...
$iblockCode = isset($_REQUEST["code"]) && $_REQUEST["code"] !== "" ? (string)$_REQUEST["code"] : "parking";
...
$addProp($mainFields, "PARKING_NUMBER");
$addProp($mainFields, "PARKING_TYPE");
$addProp($mainFields, "LEVEL");
